...
export const searchHistoryEn = {
  removeButton: "Clear History",
};

export const searchHistoryTr = {
  removeButton: "Geçmişi Temizle",
};
...
export const contactAm = {
  ...
  messageError:
    "Կը խնդրենք, որ առնուազն 30 նշան ունեցող հաղորդագրութիւն մը գրէք։",
...
export const wordleAm = {
  ...
  notEnoughLetters: "Տառերը Անբաւական Է",
  tryAgain: "Դարձեալ Փորձեցէ՛ք",
  win: "Ապրիս 🎉",
  lose: "Կորսնցուցիք",
  reset: "Նոր Խաղ",
...
export const TurkishLanguageOptions = {
  searchLine: searchLineTr,
  searchHistory: searchHistoryTr,
  navBar: navBarTr,
...
export const ArmenianLanguageOptions = {
  searchLine: searchLineAm,
  searchHistory: searchHistoryAm,
  navBar: navBarAm,
